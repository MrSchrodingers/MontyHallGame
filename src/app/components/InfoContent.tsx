  ...
  return (
    ...
    >
      <article className="w-full grid text-justify">
        <h1 className="flex justify-self-start px-4 mb-4 text-4xl font-extrabold tracking-tight leading-none md:text-5xl xl:text-6xl dark:text-white lg:mr-8">Monty Hall Game</h1>
        <p className="max-w-7xl mb-4 px-10 font-light text-gray-500 lg:mb-8 md:text-lg lg:text-xl dark:text-gray-400">
